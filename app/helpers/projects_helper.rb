...
##next line has been altered
  ...
  @line = specline
    ...
    case specline.linetype_id
      ...
      when 3 ; "#{html_prefix(specline)}  <td width='10px'></td><td class='prefix' width='18'>#{specline.txt1.text}.</td><td><span id='#{specline.id}' class='editable_text4'>#{specline.txt4.text}</span>: <span id='#{specline.id}'class='editable_text5'>#{specline.txt5_text}.</span></td>   <td class='padding'></td>#{specline_links(specline)}</tr></table>".html_safe
      ...
      when 5 ; "#{html_prefix(specline)}  <td class='prefix' width='10px'>-</td><td><table><tr><td><span id='#{specline.id}'class='editable_text3'>#{specline.txt3.text}</span></td><td>:</td><td width = '5'></td><td><span id='#{specline.id}'class='editable_text6'>#{specline.txt6_text}.</span></td></tr></table></td>   <td class='padding'></td>#{specline_links(specline)}</tr></table></td>".html_safe

      when 6 ; "#{html_prefix(specline)}  <td class='prefix' width='10px'>-</td><td><table><tr><td><span id='#{specline.id}'class='editable_text3'>#{specline.txt3.text}</span></td><td>:</td><td width = '5'></td><td><span id='#{specline.id}'class='editable_text5'>#{specline.txt5_text}.</span></td></tr></table></td>   <td class='padding'></td>#{specline_links(specline)}</tr></table></td>".html_safe
      ...
      when 8 ; "#{html_prefix(specline)}  <td class='prefix' width='10px'>-</td><td><span id='#{specline.id}'class='editable_text4'>#{specline.txt4.text}</span>: <span id='#{specline.id}'class='editable_text5'>#{specline.txt5_text}.</span></td>   <td class='padding'></td>#{specline_links(specline)}</tr></table>".html_safe
