...
#     when 11 ; "#{html_prefix(specline)}  <td class='product_prefix' width='10px'>-</td><td class='product_text'><span id='#{specline.id}'class='editable_text3'>#{specline.txt3.text}</span>:</td> #{html_sufix(specline)}.html_safe
