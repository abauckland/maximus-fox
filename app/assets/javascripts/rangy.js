  ...
  $(document).ready(function(){
    function e(a,b){
      return function(){
        ...
        if(c.nodeType==1&&(d=="textarea"||d=="input"&&c.type=="text")){
          c=[c].concat(Array.prototype.slice.call(arguments));
          c=a.apply(this,c);
          if(!b)return c}if(b)return this
        }
      }
      ...
      if(typeof g.selectionStart!="undefined"&&typeof g.selectionEnd!="undefined"){  
        ...
        m=function(a,b){
          if(b)a.selectionEnd=a.selectionStart;
          else a.selectionStart=a.selectionEnd
        }
        ...
        i=function(a){
          ...
          if((j=document.selection.createRange())&&j.parentElement()==a){
            ...
            if(c.compareEndPoints("StartToEnd",j)>-1)b=c=f;
            else{
    ...
    q=function(a){
      var b=i(a);l(a,b.start,b.end,true)
    };
    ...
    r=function(a,b,c,d){
      var f=a.value;a.value=f.slice(0,c)+b+f.slice(c);

      if(d){b=c+b.length;h(a,b,b)}};s=function(a,b){
        var c=i(a),
        d=a.value;
